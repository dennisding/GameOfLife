...
//	wgpuRenderPassEncoderRelease(render_pass_encoder_);
	...
	//WGPUCommandBuffer command = wgpuCommandEncoderFinish(command_encoder_, &command_buffer_descriptor);

	//wgpuCommandEncoderRelease(command_encoder_); // release encoder after it finished
